<?php
  include_once("../resources/views/modal_cadastrar.php");
  ...
  include_once("../resources/views/modal_cadastrar.php");
  include_once("../resources/views/modal_atualizar.php");
  include_once("../resources/views/modal_excluir.php");
  include_once("../resources/views/modal_prontuario.php");
  $mysqli = new Conexao();
...
<?php /**PATH C:\xampp\htdocs\softmidia\teste\resources\views/menu.blade.php ENDPATH**/ ?>